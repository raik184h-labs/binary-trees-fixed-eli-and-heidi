...
public class LabRunner {
    ...
    public static void main(String[] args) {
        ...
        insertIntoBSTAndPrintResults(bst, new Person(111111111, "Anna Duplicate"));
        searchInBSTAndPrintResults(bst, 999999999);
        deleteFromBSTAndPrintResults(bst, 999999999);
    ...
    private static void searchInBSTAndPrintResults(BinarySearchTree bst, int key) {
        ...
        // print the results
        if (found == null) {
            System.out.println("No person found with NUID " + key + ".");
        } else {
    ...
    private static void deleteFromBSTAndPrintResults(BinarySearchTree bst, int key) {
        ...
        // print the results
        if (deleted == null) {
            System.out.println("No person deleted (NUID " + key + " not found).");
        } else {
